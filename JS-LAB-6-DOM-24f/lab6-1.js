...
function pageReady(){
	...
	var image4 = document.getElementById("pic4"); //image4
	var image5 = document.getElementById("pic5"); //image5
	var image6 = document.getElementById("pic6"); //image6
	...
	image4.onmouseover = switchPic4; // Setup listener for pic4
	image5.onmouseover = switchPic5; // Setup listener for pic5
	image6.onmouseover = switchPic6; // Setup listener for pic6
	...
	function switchPic4(){ // Add function for pic4
		bigImage.src = image4.src;
	}

	function switchPic5(){ // Add function for pic5
		bigImage.src = image5.src;
	}

	function switchPic6(){ // Add function for pic6
	...
	image4.onmouseout = resetPic; // Setup listener for pic4
	image5.onmouseout = resetPic; // Setup listener for pic5
	image6.onmouseout = resetPic; // Setup listener for pic6
}//END onload FUNCTION